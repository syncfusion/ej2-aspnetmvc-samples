    ...
    public class ScheduleData
    {
        ...
        public List<AppointmentData> GetReminderEventsData()
        {
            ...
            reminderEventsData.Add(new AppointmentData
            {
                Id = 1,
                Subject = "Explosion of Betelgeuse Star",
                Location = "Space Centre US",
                StartTime = new DateTime(today.Year, today.Month, today.Day, today.Hour, today.Minute, today.AddSeconds(10).Second, DateTimeKind.Utc),
                EndTime = new DateTime(today.Year, today.Month, today.Day, today.AddHours(2).Hour, today.Minute, today.AddSeconds(10).Second, DateTimeKind.Utc),
                StartTimezone = "UTC",
                EndTimezone = "UTC"
            });
            reminderEventsData.Add(new AppointmentData
