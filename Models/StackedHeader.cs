...
using System.Linq;
using System.Web;
using static EJ2MVCSampleBrowser.Controllers.SidebarController;

namespace EJ2MVCSampleBrowser.Models
{
    public class StackedHeader
    {
        ...
        public StackedHeader(int orderId, int customerId, string customerName, DateTime orderDate, DateTime shippedDate, double freight, string shipName, string shipAddress, string shipCity, string shipRegion, string shipCountry, int year, int salary, int feedback, string status)
        {
        ...
        public static List<StackedHeader> GetStackedHeaders(long count)
        {
            ...
            List<StackedHeader> stackedHeader = new List<StackedHeader>();
            for (int i = 1; i <= count; i++)
            {
                stackedHeader.Add(new StackedHeader(
                    150000 + i,
                    1000 + i,
