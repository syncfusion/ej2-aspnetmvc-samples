...
namespace EJ2MVCSampleBrowser.Models
{
    public class InventorDetails
    {
        ...
        public static List<InventorDetails> GetAllRecords()
        {
            ...
            inventor.Add(new InventorDetails("2001-2016", "USA", "Roderick A. Hyde", "Medical devices, Nuclear engineering, Photonics, Nanotechnology, Energy systems, Geoengineering.", 3360, 1240));
            ...
            inventor.Add(new InventorDetails("1996-2016", "USA", "Edward K. Y. Jung", "Software systems, Medical devices, Nanotechnology, Display technology, User interfaces.", 2254, 911));
            ...
            inventor.Add(new InventorDetails("2000-2016", "USA", "Clarence T. Tegreene", "Optics, Photonics, MEMS, Nanotechnology, Medical devices, Energy systems.", 2255, 872));
            ...
            inventor.Add(new InventorDetails("1999-2016", "USA", "Rick Allen Hamilton II", "Cloud computing, Distributed systems, Virtualization, IT management, Collaboration software.", 1064, 773));
            ...
            inventor.Add(new InventorDetails("1994-2016", "USA", "Nathan Myhrvold", "Software, Medical devices, Nuclear reactors, Food science, Optics, Geoengineering.", 1690, 661));
            ...
            inventor.Add(new InventorDetails("1997-2016", "USA", "Mark Malamud", "User interfaces, Augmented reality, Human-computer interaction, Mobile systems.", 1759, 632));
            inventor.Add(new InventorDetails("1997-2016", "USA", "Royce A. Levien", "Software systems, Cryptography, User interfaces, E-commerce, Nanotechnology.", 1799, 630));
            inventor.Add(new InventorDetails("1997-2014", "USA", "Audrey D. Goddard", "Proteins, Antibodies.", 3416, 622));
            inventor.Add(new InventorDetails("2002-2016", "USA", "Muriel Y. Ishikawa", "Medical devices, Biotechnology, Nanotechnology, Photonics.", 1660, 619));
            inventor.Add(new InventorDetails("2003-2016", "USA", "Robert W. Lord", "Software, Medical devices, User interfaces, Nanotechnology, Energy systems.", 1708, 618));
            ...
            inventor.Add(new InventorDetails("1992-2016", "USA", "Jordin T. Kare", "Laser propulsion, Medical devices, Space systems, Nanotechnology, Energy weapons.", 1559, 585));
            ...
            inventor.Add(new InventorDetails("1988-2016", "USA", "Louis L. Hsu", "DRAM, CMOS circuits, Semiconductor memory, Interconnects.", 914, 551));
            ...
            inventor.Add(new InventorDetails("1987-2014", "USA", "Jack A. Mandelman", "DRAM, SRAM, Trench capacitors, CMOS fabrication.", 889, 481));
            ...
            inventor.Add(new InventorDetails("2001-2016", "USA", "John M. Santosuosso", "Software, Operating systems, Virtualization, Cloud computing.", 683, 473));
            ...
            inventor.Add(new InventorDetails("1983-2016", "USA", "fe", "Surgical staplers, Minimally invasive surgery devices, Endocutters.", 1759, 430));
            ...
            inventor.Add(new InventorDetails("2009-2016", "USA", "Victoria Y. H. Wood", "Nanotechnology, Photonics, Metamaterials, Energy systems, Medical devices.", 1045, 400));
            ...
            inventor.Add(new InventorDetails("1992-2016", "USA", "David V. Horak", "Semiconductor manufacturing, BEOL interconnects, CMOS integration.", 616, 380));
            ...
            inventor.Add(new InventorDetails("2008-2016", "USA", "Gregory J. Boss", "Cloud computing, IT management, Business methods, Software services.", 588, 345));
            inventor.Add(new InventorDetails("1987-2016", "USA", "Mark W. Kroll", "Implantable medical devices.", 460, 343));
            inventor.Add(new InventorDetails("2009-2016", "USA", "Brian M. O'Connell", "Web applications, Software services, Cloud computing, Collaboration tools.", 592, 331));
            inventor.Add(new InventorDetails("1986-2016", "USA", "William Daniel Hillis", "Parallel computing, Massively parallel supercomputers, Touch interfaces.", 229, 328));
            ...
            inventor.Add(new InventorDetails("1992-2016", "USA", "Clifford A. Pickover", "Visualization, Mathematics in computing, User interfaces, Fractals.", 653, 317));
            ...
            inventor.Add(new InventorDetails("2003-2016", "Saudi Arabia", "Keith R. Walker", "Software, Business methods, User interfaces.", 318, 282));
            inventor.Add(new InventorDetails("1982-2016", "USA", "Victor S. Moore", "Speech recognition, Voice user interfaces, Accessibility software.", 428, 280));
            inventor.Add(new InventorDetails("1987-2016", "USA", "Hanson S. Gifford III", "Medical Devices.", 795, 276));
            inventor.Add(new InventorDetails("1982-2016", "USA", "Daniel J. Winarski", "Data storage systems, Optical disks, Hard disk drives, RAID technology.", 506, 275));
            inventor.Add(new InventorDetails("1968-2016", "Romania", "Adam Heller", "Solar cells, Glucose meters, Lasers.", 711, 272));
            inventor.Add(new InventorDetails("2009-2016", "USA", "Lisa Seacat DeLuca", "Cognitive computing, Mobile applications, Internet of Things, User experience.", 385, 271));
            ...
            inventor.Add(new InventorDetails("2003-2016", "USA", "Kulvir S. Bhogal", "Software, Cloud computing, Virtualization, Web services.", 486, 252));
            ...
            inventor.Add(new InventorDetails("1982-2016", "USA", "Philip S. Yu", "Data mining, Database systems, Graph algorithms, Web services.", 158, 236));
            ...
            inventor.Add(new InventorDetails("1996-2016", "USA", "Johnny M. Shieh", "Software, Business processes, User interfaces.", 444, 231));
            ...
            inventor.Add(new InventorDetails("1997-2016", "USA", "Gerald F. McBrearty", "Operating systems, Device drivers, Performance optimization.", 387, 213));
