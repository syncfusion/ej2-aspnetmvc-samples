...
namespace EJ2MVCSampleBrowser.Models
{
    public class PromptResponseData
    {
        ...
        public List<string> ResponseChunks { get; set; }
        public List<string> RegeneratedResponses { get; set; }
        public List<string> SuggestionData { get; set; }

        public static string[] GenerativeSuggestions = new string[]
        {
        ...
        public static object ChartBlockData = new object[]
        {
            ...
            new {
                ...
                props = new {
                    ...
                    privateConsumptionData = new object[]
                    {
                        new { x = "2005", y = 1.2 },
                        new { x = "2006", y = 1 },
                        new { x = "2007", y = 1 },
                    ...
                    governmentConsumptionData = new object[]
                    {
                        new { x = "2005", y = 0.5 },
                        new { x = "2006", y = 0.5 },
                        new { x = "2007", y = 0.5 },
            ...
            new {
                blockType = "text",
                content =
                    "The data shows noticeable fluctuations in overall GDP growth, " +
                    "with private and government consumption contributing positively across most periods. " +
                    "Investment displays higher volatility compared to other sectors, while foreign trade " +
                    "remains relatively negative throughout. Overall, the chart indicates periods of slowdown " +
                    "followed by gradual economic recovery and stabilization."
            }
        };
        ...
        public Dictionary<string, string> GetModelIcons()
        {
        ...
        public Dictionary<int, string> GetIconMapByIndex()
        {
