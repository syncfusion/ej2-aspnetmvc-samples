...
namespace EJ2MVCSampleBrowser.Models
{
    public partial class Product
    {
        ...
        public static List<Product> GetAllRecords()
        {
            ...
            product.Add(new Product("36 boxes", "Chef Anton's Gumbo Mix", 5, 2, 21.35, true, 10));
            ...
            product.Add(new Product("20 - 1 kg tins", "Alice Mutton", 17, 7, 39, true, 23));
            ...
            product.Add(new Product("50 bags x 30 sausgs.", "Thringer Rostbratwurst", 29, 12, 123.79, true,46));
            product.Add(new Product("10 - 200 g glasses", "Nord-Ost Matjeshering", 30, 13, 25.89, true, 10));
            product.Add(new Product("12 - 100 g pkgs", "Gorgonzola Telino", 31, 14, 12.5, true, 48));
            ...
            product.Add(new Product("48 pieces", "Perth Pasties", 53, 24, 32.8, true, 12));
