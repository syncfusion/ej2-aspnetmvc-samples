...
namespace EJ2MVCSampleBrowser.Models
{
    public class GanttData
    {
        public class GanttDataSource
        {
            ...
            // Custom baselines
            public DateTime? RevisedBaseline { get; set; }
            public int? RevisedBaselineDuration { get; set; }
            public DateTime? FinalBaseline { get; set; }
            public int? FinalBaselineDuration { get; set; }
        ...
        public static List<GanttDataSource> PdfExportData()
        {
            List<GanttDataSource> GanttDataSourceCollection = new List<GanttDataSource>();
            GanttDataSource Record1 = new GanttDataSource()
            {
        ...
        public static List<GanttDataSource> EventMarkerData()
        {
            ...
            GanttDataSourceCollection.Add(new GanttDataSource
            {
                ...
                Indicators = new List<IndicatorsModel>
                {
                    new IndicatorsModel { date = new DateTime(2025, 4, 7), name = "Research phase start", tooltip = "Research begins", iconClass = "e-icons e-ok" },
                    new IndicatorsModel { date = new DateTime(2025, 4, 7), name = "Kick-off meeting", tooltip = "Team aligned", iconClass = "e-icons e-meeting" }
                }
            }); 
            ...
            GanttDataSourceCollection.Add(new GanttDataSource
            {
                ...
                Indicators = new List<IndicatorsModel>
                {
                    new IndicatorsModel { date = new DateTime(2025, 4, 17), name = "Design phase start", tooltip = "Design team engaged", iconClass = "e-icons e-design" },
                    new IndicatorsModel { date = new DateTime(2025, 4, 17), name = "UI review", tooltip = "UI mockups reviewed", iconClass = "e-icons e-review" }
                }
            }); 
            ...
            GanttDataSourceCollection.Add(new GanttDataSource
            {
                ...
                Indicators = new List<IndicatorsModel>
                {
                    new IndicatorsModel { date = new DateTime(2025, 5, 30), name = "Production phase", tooltip = "Production phase completed", iconClass = "okIcon e-icons" }
                }
            }); 
            ...
            GanttDataSourceCollection.Add(new GanttDataSource
            {
                ...
                Indicators = new List<IndicatorsModel>
                {
                    new IndicatorsModel { date = new DateTime(2025, 5, 23), name = "Production phase start", tooltip = "Factory starts", iconClass = "e-icons e-production" },
                    new IndicatorsModel { date = new DateTime(2025, 5, 23), name = "Factory hand-over", tooltip = "Keys handed over", iconClass = "e-icons e-handover" }
                }
            }); 
            ...
            GanttDataSourceCollection.Add(new GanttDataSource
            {
                ...
                Indicators = new List<IndicatorsModel>
                {
                    new IndicatorsModel { date = new DateTime(2025, 6, 30), name = "Sales and marketing", tooltip = "Sales and marketing", iconClass = "description e-icons" }
                }
            }); 
            ...
            GanttDataSourceCollection.Add(new GanttDataSource
            {
                ...
                Indicators = new List<IndicatorsModel>
                {
                    new IndicatorsModel { date = new DateTime(2025, 6, 27), name = "Sales launch", tooltip = "Product live", iconClass = "e-icons e-launch" },
                    new IndicatorsModel { date = new DateTime(2025, 6, 27), name = "Press release", tooltip = "Media coverage", iconClass = "e-icons e-press" }
                }
            }); 

            return GanttDataSourceCollection;
        }
        public static List<GanttDataSource> InfiniteTimelineScrollData()
        {
            var dataSource = new List<GanttDataSource>();

            // =======================
            // Project Kickoff & Planning
            // =======================
            dataSource.Add(new GanttDataSource
            {
                TaskId = 1,
            ...
            dataSource.Add(new GanttDataSource
            {
                ...
                StartDate = new DateTime(2026, 3, 6),
        ...
        public static List<GanttDataSource> BaselineTemplateData()
        {
            ...
            // Parent Task 1
            // =======================
            data.Add(new GanttDataSource
            {
                TaskId = 1,
                TaskName = "Consumer Electronics Product Launch",
            ...
            data.Add(new GanttDataSource
            {
                ...
                // ✅ Initial baseline (Syncfusion will render this)
                BaselineStartDate = new DateTime(2024, 5, 3),
                BaselineDuration = 3,

                // ✅ Revised baseline (custom)
                RevisedBaseline = new DateTime(2024, 5, 3),
                RevisedBaselineDuration = 5,

                // ✅ Final baseline (custom)
                FinalBaseline = new DateTime(2024, 5, 3),
                FinalBaselineDuration = 7
            });
            ...
            data.Add(new GanttDataSource
            {
                ...
                StartDate = new DateTime(2024, 5, 4),
                Duration = 4,
                Progress = 90,
                ParentID = 1,
                Predecessor = "2FS",

                BaselineStartDate = new DateTime(2024, 5, 7),
                BaselineDuration = 0,

                RevisedBaseline = new DateTime(2024, 5, 8),
                RevisedBaselineDuration = 1,

                FinalBaseline = new DateTime(2024, 5, 9),
                FinalBaselineDuration = 1
            });
            ...
            data.Add(new GanttDataSource
            {
                ...
                BaselineStartDate = new DateTime(2024, 5, 6),
                BaselineDuration = 3,

                RevisedBaseline = new DateTime(2024, 5, 6),
                RevisedBaselineDuration = 3,

                FinalBaseline = new DateTime(2024, 5, 6),
                FinalBaselineDuration = 3
            });
            ...
            data.Add(new GanttDataSource
            {
                ...
                BaselineStartDate = new DateTime(2024, 5, 13),
                BaselineDuration = 3,

                RevisedBaseline = new DateTime(2024, 5, 14),
                RevisedBaselineDuration = 3,

                FinalBaseline = new DateTime(2024, 5, 15),
                FinalBaselineDuration = 3
            });
            ...
            data.Add(new GanttDataSource
            {
                ...
                BaselineStartDate = new DateTime(2024, 5, 10),
                BaselineDuration = 3,

                RevisedBaseline = new DateTime(2024, 5, 10),
                RevisedBaselineDuration = 2,

                FinalBaseline = new DateTime(2024, 5, 10),
                FinalBaselineDuration = 1
            });
            ...
            data.Add(new GanttDataSource
            {
                ...
                EndDate = new DateTime(2024, 5, 13),
                Progress = 50
            });
            ...
            data.Add(new GanttDataSource
            {
                ...
                BaselineStartDate = new DateTime(2024, 5, 4),
                BaselineDuration = 0,

                RevisedBaseline = new DateTime(2024, 5, 5),
                RevisedBaselineDuration = 0,

                FinalBaseline = new DateTime(2024, 5, 6),
                FinalBaselineDuration = 0
            });
            ...
            data.Add(new GanttDataSource
            {
                ...
                BaselineStartDate = new DateTime(2024, 5, 9),
                BaselineDuration = 1,
            ...
            data.Add(new GanttDataSource
            {
                ...
                FinalBaseline = new DateTime(2024, 5, 11),
                FinalBaselineDuration = 3
            });
            ...
            data.Add(new GanttDataSource
            {
                ...
                BaselineStartDate = new DateTime(2024, 5, 20),
                BaselineDuration = 3,

                RevisedBaseline = new DateTime(2024, 5, 21),
                RevisedBaselineDuration = 3,

                FinalBaseline = new DateTime(2024, 5, 22),
                FinalBaselineDuration = 3
            });
