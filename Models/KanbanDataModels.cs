...
namespace EJ2MVCSampleBrowser.Models
{
    public class KanbanDataModels
    {
        ...
        public List<KanbanDataModels> KanbanPizzaData()
        {
            ...
            PizzaData.Add(new KanbanDataModels { Id= "1", OrderID= "Order ID - #16365", Title= "Mexican Green Wave", Type= "Vegetarian", Size="Small", Category="Order", Description= "Stromboli sandwich with chili sauce.", Tags= "Onions, Pepper, Cheese", ImageURL= "Mexican_Green_Wave.jpg", Price= "$4.79", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id= "2", OrderID= "Order ID - #16366", Title= "Fresh Veggie", Type= "Vegetarian", Size= "Medium", Category= "Order", Description= "Veggie with Onions and Capsicum.", Tags= "Onions, Capsicum", ImageURL= "Fresh_Veggie.jpg", Price= "$11.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "3", OrderID = "Order ID - #16367", Title = "Peppy Paneer", Type = "Vegetarian", Size = "Large", Category = "Ready to Serve", Description = "It's made using toppings of tomato, mozzarella cheese and fresh basil.", Tags = "Onions, Pepper, Cheese", ImageURL = "Peppy_Paneer.jpg", Price= "$14.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "4", OrderID = "Order ID - #16368", Title = "Margherita", Type = "Vegetarian", Size = "Small", Category = "Menu", Description = "Lebanese Pizza topped with tomato sauce.", Tags = "Onions, Pepper, Cheese", ImageURL = "Margherit.jpg", Price = "$4.79", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "5", OrderID = "Order ID - #16369", Title = "Indian Tandoori Paneer", Type = "Vegetarian", Size = "Medium", Category = "Delivered", Description = "Tandoori Paneer with capsicum, red paprika and mint.", Tags = "Paneer, Capsicum, Paprika, Mint", ImageURL = "IndianTandooriPaneer.jpg", Price = "$11.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "6", OrderID = "Order ID - #16370", Title = "Pepper Barbecue Chicken", Type = "Non-Vegetarian", Size = "Medium", Category = "Ready to Serve", Description = "Pepper Barbecue Chicken with cheese.", Tags = "Pepper, Chicken, Cheese", ImageURL = "Pepper_Barbeque.jpg", Price = "$11.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "7", OrderID = "Order ID - #16371", Title = "Chicken Sausage", Type = "Non-Vegetarian", Size = "Large", Category = "Ready to Serve", Description = "Chicken Sausage with cheese.", Tags = "Cheese, Chicken", ImageURL = "Chicken_Sausage.jpg", Price= "$14.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "8", OrderID = "Order ID - #16372", Title = "Chicken Golden Delight", Type = "Non-Vegetarian", Size = "Large", Category = "Order", Description = "Barbeque chicken with a topping of golden corn loaded with extra cheese.", Tags = "Onions, BBQ, Prawn", ImageURL = "Chicken_Golden_Delight.jpg", Price="$14.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "9", OrderID = "Order ID - #16373", Title = "Pepper Barbecue and Onion", Type = "Non-Vegetarian", Size = "Medium", Category = "Menu", Description = "Pepper Barbecue chicken with Onion.", Tags = "Pepper, Chicken", ImageURL = "Pepper_Barbeque_Onion.jpg", Price = "$11.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "10", OrderID = "Order ID - #16374", Title = "Chicken Fiesta", Type = "Non-Vegetarian", Size = "Small", Category = "Delivered", Description = "Grilled Chicken Rashers with Peri-Peri chicken, Onion and Capsicum.", Tags = "Chicken, Capsicum", ImageURL = "chunky-chicken.png", Price= "$4.79", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            ...
            PizzaData.Add(new KanbanDataModels { Id = "13", OrderID = "Order ID - #16377", Title = "Cheese and Corn", Type = "Vegetarian", Size = "Large", Category = "Order", Description = "Cheese with golden corn.", Tags = "Cheese, Corn", ImageURL = "Corn_Cheese.jpg", Price = "$14.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "14", OrderID = "Order ID - #16378", Title = "Chicken Tikka", Type = "Non-Vegetarian", Size = "Medium", Category = "Ready to Serve", Description = "Tandoori masala with Chicken Tikka, Onion, red paprika and mint.", Tags = "Chicken, Tikka", ImageURL = "IndianChickenTikka.jpg", Price = "$11.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "15", OrderID = "Order ID - #16379", Title = "Chicken Dominator", Type = "Non-Vegetarian", Size = "Small", Category = "Menu", Description = "Double Pepper Barbecue Chicken with Peri-Peri Chicken, Chicken Tikka, Grilled and Rashers.", Tags = "Pepper, Chicken", ImageURL = "Dominator.jpg", Price = "$4.79" , Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            ...
            PizzaData.Add(new KanbanDataModels { Id = "18", OrderID = "Order ID - #16382", Title = "Veg Extravanganza", Type = "Vegetarian", Size = "Large", Category = "Served", Description = "Pizza with corn, olives, onions, capsicum, tomatoes and jalapeno with cheese to go all around.", Tags = "Corn, Mushrooms", ImageURL = "Veg_Extravaganz.jpg", Price = "$14.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "19", OrderID = "Order ID - #16383", Title = "Margherita", Type = "Vegetarian", Size = "Large", Category = "Ready to Deliver", Description = "Lebanese Pizza topped with tomato sauce.", Tags = "Onions, Pepper, Cheese", ImageURL = "Margherit.jpg", Price = "$4.99",Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
            PizzaData.Add(new KanbanDataModels { Id = "20", OrderID = "Order ID - #16384", Title = "Pepper Barbecue and Onion", Type = "Non-Vegetarian", Size = "Medium", Category = "Ready to Deliver", Description = "Pepper Barbecue chicken with Onion.", Tags = "Onions, Pepper, Chicken", ImageURL = "Pepper_Barbeque_Onion.jpg", Price = "$11.99", Date = new DateTime(2022, 01, 23).ToString("MM/dd/yyyy") });
