...
namespace EJ2MVCSampleBrowser.Controllers.Diagram
{
    public partial class DiagramController : Controller
    {
        ...
        public ActionResult DefaultFunctionalities()
        {
            ...
            buttons.Add(new DialogDialogButton() { Click = "saveButtonClick", ButtonModel = new DialogButtonModel() { content = "Save", isPrimary = true } });
            buttons.Add(new DialogDialogButton() { Click = "dontSaveButtonClick", ButtonModel = new DialogButtonModel() { content = "Don't Save" } });
            buttons.Add(new DialogDialogButton() { Click = "cancelButtonClick", ButtonModel = new DialogButtonModel() { content = "Cancel" } });
            ViewData["DialogButtons"] = buttons;
            return View();
        }
