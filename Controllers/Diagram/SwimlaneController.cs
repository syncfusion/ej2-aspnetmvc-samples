...
namespace EJ2MVCSampleBrowser.Controllers.Diagram
{
    public partial class DiagramController : Controller
    {
        ...
        public ActionResult Swimlane()
        {
            ...
            SymbolPaletee.Add(new DiagramNode() { Id = "Terminator", AddInfo = addInfo, Ports = ports, Width = 50, Height = 50, Shape = new { type = "Flow", shape = "Terminator" }, Style = new DiagramTextStyle() { StrokeWidth = 1 } });
            Dictionary<string, object> addInfo1 = new Dictionary<string, object>();
            addInfo1.Add("tooltip", "Process");
            SymbolPaletee.Add(new DiagramNode() { Id = "Process", AddInfo = addInfo1, Ports = ports, Width = 50, Height = 50, Shape = new { type = "Flow", shape = "Process" }, Style = new DiagramTextStyle() { StrokeWidth = 1 } });
            Dictionary<string, object> addInfo2 = new Dictionary<string, object>();
            addInfo2.Add("tooltip", "Document");
            SymbolPaletee.Add(new DiagramNode() { Id = "Document", AddInfo = addInfo2, Ports = ports, Width = 50, Height = 50, Shape = new { type = "Flow", shape = "Document" }, Style = new DiagramTextStyle() { StrokeWidth = 1 } });
            Dictionary<string, object> addInfo3 = new Dictionary<string, object>();
            addInfo3.Add("tooltip", "Predefined process");
            SymbolPaletee.Add(new DiagramNode() { Id = "PreDefinedProcess", AddInfo = addInfo3, Ports = ports, Width = 50, Height = 50, Shape = new { type = "Flow", shape = "PreDefinedProcess" }, Style = new DiagramTextStyle() { StrokeWidth = 1 } });
            Dictionary<string, object> addInfo4 = new Dictionary<string, object>();
            addInfo4.Add("tooltip", "Data");
            SymbolPaletee.Add(new DiagramNode() { Id = "data", AddInfo = addInfo4, Ports = ports, Width = 50, Height = 50, Shape = new { type = "Flow", shape = "Data" }, Style = new DiagramTextStyle() { StrokeWidth = 1 } });
            List<Lane> lanes = new List<Lane>();
            Lane lane1 = new Lane();
            lane1.Id = "lane1";
            lane1.Height = 60;
            lane1.Width = 150;
            lane1.Header = new Header() { Width = 50, Height = 50, Style = new DiagramTextStyle() {  FontSize = 11 } };
            lanes.Add(lane1);
            ...
            lane2.Height = 150;
            lane2.Width = 60;
            lane2.Header = new Header() { Width = 50, Height = 50, Style = new DiagramTextStyle() { FontSize = 11 } };
            lanes1.Add(lane2);
            ...
            swimlanePalette.Add(new DiagramNode()
            {
                ...
                Style = new DiagramTextStyle() { StrokeColor = "black" },
                OffsetX = 70,
                OffsetY = 30
            });
