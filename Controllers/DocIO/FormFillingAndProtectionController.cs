    ...
    public partial class DocIOController : Controller
    {
        public ActionResult FormFillingAndProtection(string Button)
        {
            ...
            if (Button == "View Template")
                return new TemplateResult("ContentControlTemplate.docx", ResolveApplicationDataPath("Data\\DocIO"), HttpContext.ApplicationInstance.Response);

            //Creates an Word document instance.
            WordDocument document = new WordDocument();

            //Loads the template document.
            document.Open(ResolveApplicationDataPath("ContentControlTemplate.docx", "Data\\DocIO"));
