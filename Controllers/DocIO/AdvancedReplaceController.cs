    ...
    public partial class DocIOController : Controller
    {
        public ActionResult AdvancedReplace(string Group1, string Button)
        {
            ...
            if (Button == "View Template")
                return new TemplateResult("MasterTemplate.doc", ResolveApplicationDataPath("Data\\DocIO"), HttpContext.ApplicationInstance.Response);
            try
            {
                ...
                // Load Templates.
                docSource1.Open(ResolveApplicationDataPath("SourceTemplate1.doc", "Data\\DocIO"), FormatType.Doc);
                docSource2.Open(ResolveApplicationDataPath("SourceTemplate2.doc", "Data\\DocIO"), FormatType.Doc);
                docMaster.Open(ResolveApplicationDataPath("MasterTemplate.doc", "Data\\DocIO"), FormatType.Doc);
