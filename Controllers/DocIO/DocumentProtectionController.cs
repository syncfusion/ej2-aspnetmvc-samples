...
namespace EJ2MVCSampleBrowser.Controllers.DocIO
{
    public partial class DocIOController : Controller
    {
        ...
        public ActionResult DocumentProtection(string Protection_Type, string Password1, string Group2)
        {
            ...
            {
                document = new WordDocument(ResolveApplicationDataPath("TemplateFormFields.doc", "Data\\DocIO"));
            ...
            {
                document = new WordDocument(ResolveApplicationDataPath("TemplateComments.doc", "Data\\DocIO"));
            ...
            {
                document = new WordDocument(ResolveApplicationDataPath("TemplateRevisions.doc", "Data\\DocIO"));
            ...
            {
                document = new WordDocument(ResolveApplicationDataPath("Essential DocIO.doc", "Data\\DocIO"));
