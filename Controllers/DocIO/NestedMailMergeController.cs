...
namespace EJ2MVCSampleBrowser.Controllers.DocIO
{
    public partial class DocIOController : Controller
    {
        ...
        public ActionResult NestedMailMerge(string Group1, string Group2, string Group3, string Button)
        {
            ...
            {
                if (Group2 == "Report")
                    return new TemplateResult("Template_Report.doc", ResolveApplicationDataPath("Data\\DocIO"), HttpContext.ApplicationInstance.Response);
                else
                    return new TemplateResult("Template_Letter.doc", ResolveApplicationDataPath("Data\\DocIO"), HttpContext.ApplicationInstance.Response);
            }
            string dataPath = string.Empty;
            if (Group2 == "Report")
                dataPath = ResolveApplicationDataPath("Template_Report.doc", "Data\\DocIO");
            else
                dataPath = ResolveApplicationDataPath("Template_Letter.doc", "Data\\DocIO");
            ...
            if (Group3 == "Explicit")
            {
                ...
                ds.ReadXml(ResolveApplicationDataPath("Employees.xml", "Data\\DocIO"));
        ...
        private MailMergeDataTable GetMailMergeDataTable()
        {
            ...
            FileStream fs = new FileStream(ResolveApplicationDataPath("Employees.xml", "Data\\DocIO"), FileMode.Open, FileAccess.Read);
