    ...
    public partial class DocIOController : Controller
    {
        ...
        public ActionResult MailMergeEvent(string Group1, string Button)
        {
            ...
            if (Button == "View Template")
                return new TemplateResult("Template.doc", ResolveApplicationDataPath("Data\\DocIO"), HttpContext.ApplicationInstance.Response);

            try
            {
                // Load the template.
                WordDocument document = new WordDocument(ResolveApplicationDataPath("Template.doc", "Data\\DocIO"));
        ...
        private void MergeField_ProductImage(object sender, MergeImageFieldEventArgs args)
        {
            ...
            if (args.FieldName == "ProductImage")
            {
                ...
                args.Image = System.Drawing.Image.FromFile(ResolveApplicationDataPath(ProductFileName, "Images\\DocIO"));
            }
        }
