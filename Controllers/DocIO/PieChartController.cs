    ...
    public partial class DocIOController : Controller
    {
        ...
        public ActionResult PieChart(string Group1)
        {
           ...
           //A new document is created.
            WordDocument document = new WordDocument(ResolveApplicationDataPath("PieChart.docx", "Data\\DocIO"));
			//Get chart data from xml file
            DataSet ds = new DataSet();
            ds.ReadXml(ResolveApplicationDataPath("Products.xml", "Data\\DocIO"));
