...
namespace EJ2MVCSampleBrowser.Controllers.Carousel
{
    public partial class CarouselController : Controller
    {
        public ActionResult Overview()
        {
            ...
            {
                imageUrl = Url.Content("~/Content/carousel/images/google-pixel-6-pro.png"),
                title = "Google Pixel",
                model = "Pixel 6 Pro",
                brand = "Google",
            ...
            appData.Add(new CarouselData
            {
                imageUrl = Url.Content("~/Content/carousel/images/iphone-13-pro.png"),
                title = "iPhone",
                model = "iPhone 13 Pro",
                brand = "Apple",
            ...
            appData.Add(new CarouselData
            {
                imageUrl = Url.Content("~/Content/carousel/images/nokia-xr-20.png"),
                title = "Nokia",
                model = "XR-20",
                brand = "Nokia",
            ...
            appData.Add(new CarouselData
            {
                imageUrl = Url.Content("~/Content/carousel/images/one-plus-9-pro.png"),
                title = "OnePlus",
                model = "OP9 Pro",
                brand = "OnePlus",
            ...
            appData.Add(new CarouselData
            {
                imageUrl = Url.Content("~/Content/carousel/images/samsung-s21-fe.png"),
                title = "Samsung",
                model = "S21 FE",
                brand = "Samsung",
