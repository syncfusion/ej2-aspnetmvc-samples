...
namespace EJ2MVCSampleBrowser.Controllers.Spreadsheet
{
    public partial class SpreadsheetController : Controller
    {
        public ActionResult Print()
        {
            ...
            {
                new { CustomerName= "Sarah Johnson", MailID= "sarah.johnson@example.com", Model= "Taurus", Noofcars= "2", DeliveryDate= "07-11-2020", Amount= "8529.22" },
                new { CustomerName= "Michael Smith", MailID= "michael.smith@example.com", Model= "Sparrow", Noofcars= "1", DeliveryDate= "07-13-2021", Amount= "17866.19" },
                new { CustomerName= "Emily Davis", MailID= "emily.davis@example.com", Model= "Grand Cherokee", Noofcars= "1", DeliveryDate= "09-04-2020", Amount= "13853.09" },
                ...
                new { CustomerName= "Jessica Martinez", MailID= "jessica.martinez@example.com", Model= "LX", Noofcars= "2", DeliveryDate= "10-08-2019", Amount= "9578.45" },
                new { CustomerName= "Daniel Thompson", MailID= "daniel.thompson@example.com", Model= "Catera", Noofcars= "1", DeliveryDate= "07-01-2022", Amount= "19141.62" },
                ...
                new { CustomerName= "Ashley Brown", MailID= "ashley.brown@example.com", Model= "Regal", Noofcars= "1", DeliveryDate= "05-12-2019", Amount= "18488.80" },
                ...
                new { CustomerName= "David Hernandez", MailID= "david.hernandez@example.com", Model= "Club Wagon", Noofcars= "2", DeliveryDate= "02-02-2020", Amount= "9709.49" },
                ...
                new { CustomerName= "Andrew Lewis", MailID= "andrew.lewis@example.com", Model= "Caravan", Noofcars= "3", DeliveryDate= "02-08-2019", Amount= "7685.49" },
                new { CustomerName= "Elizabeth Clark", MailID= "elizabeth.clark@example.com", Model= "Bravada", Noofcars= "1", DeliveryDate= "08-05-2021", Amount= "18012.45" },
                new { CustomerName= "James Walker", MailID= "james.walker@example.com", Model= "Colorado", Noofcars= "3", DeliveryDate= "05-30-2021", Amount= "2785.49" },
                ...
                new { CustomerName= "Isabella King", MailID= "isabella.king@example.com", Model= "Voyager", Noofcars= "3", DeliveryDate= "04-06-2023", Amount= "8118.39" },
                ...
                new { CustomerName= "William Green", MailID= "william.green@example.com", Model= "Mirage", Noofcars= "2", DeliveryDate= "09-12-2019", Amount= "5619.25" },
                new { CustomerName= "Amelia Adams", MailID= "amelia.adams@example.com", Model= "XK", Noofcars= "1", DeliveryDate= "05-12-2021", Amount= "5091.43" },
                ...
                new { CustomerName= "Mia Turner", MailID= "mia.turner@example.com", Model= "Range Rover Sport", Noofcars= "2", DeliveryDate= "02-22-2023", Amount= "5284.87" },
                ...
                new { CustomerName= "Chloe Hill", MailID= "chloe.hill@example.com", Model= "TSX", Noofcars= "3", DeliveryDate= "02-25-2023", Amount= "2543.25" },
                ...
                new { CustomerName= "Jacob Perez", MailID= "jacob.perez@example.com", Model= "Bonneville", Noofcars= "3", DeliveryDate= "04-06-2023", Amount= "8872.52" },
                ...
                new { CustomerName= "Lily Phillips", MailID= "lily.phillips@example.com", Model= "Grand Prix", Noofcars= "2", DeliveryDate= "09-12-2019", Amount= "8546.24" },
                new { CustomerName= "Samuel Davis", MailID= "samuel.davis@example.com", Model= "Sunbird", Noofcars= "3", DeliveryDate= "02-08-2019", Amount= "8844.25" },
                new { CustomerName= "Zoey Campbell", MailID= "zoey.campbell@example.com", Model= "Mirage", Noofcars= "2", DeliveryDate= "08-05-2021", Amount= "9635.25" },
                new { CustomerName= "Daniel Cooper", MailID= "daniel.cooper@example.com", Model= "XK", Noofcars= "3", DeliveryDate= "05-30-2021", Amount= "7854.24" },
                ...
                new { CustomerName= "Sophia Henderson", MailID= "sophia.henderson@example.com", Model= "Pathfinder", Noofcars= "2", DeliveryDate= "08-30-2019", Amount= "9154.34" },
                ...
                new { CustomerName= "Claire Rogers", MailID= "claire.rogers@example.com", Model= "Bonneville", Noofcars= "3", DeliveryDate= "10-01-2019", Amount= "7963.35" },
                ...
                new { CustomerName= "Aubrey Long", MailID= "aubrey.long@example.com", Model= "Voyager", Noofcars= "1", DeliveryDate= "08-21-2019", Amount= "12864.35" },
                new { CustomerName= "Julian Coleman", MailID= "julian.coleman@example.com", Model= "Grand Prix", Noofcars= "2", DeliveryDate= "07-07-2021", Amount= "7985.36" },
                new { CustomerName= "Leah Reed", MailID= "leah.reed@example.com", Model= "Sunbird", Noofcars= "1", DeliveryDate= "02-03-2022", Amount= "19245.36" },
                new { CustomerName= "Gabriel Bell", MailID= "gabriel.bell@example.com", Model= "Mirage", Noofcars= "3", DeliveryDate= "01-23-2021", Amount= "7835.36" },
                new { CustomerName= "Natalie Ward", MailID= "natalie.ward@example.com", Model= "XK", Noofcars= "1", DeliveryDate= "08-06-2020", Amount= "16324.35" },
                new { CustomerName= "Lucas Brooks", MailID= "lucas.brooks@example.com", Model= "Accord", Noofcars= "2", DeliveryDate= "11-01-2019", Amount= "8845.34" },
                new { CustomerName= "Hailey Mitchell", MailID= "hailey.mitchell@example.com", Model= "Range Rover Sport", Noofcars= "1", DeliveryDate= "08-17-2023", Amount= "12684.35" },
                new { CustomerName= "Jackson Ward", MailID= "jackson.ward@example.com", Model= "Runner", Noofcars= "1", DeliveryDate= "03-03-2019", Amount= "15093.36" }

            };
            List<object> yearlyReport = new List<object>()
            {
        ...
        {
            string allText = System.IO.File.ReadAllText(Server.MapPath("~/Scripts/SpreadsheetImage.txt"));
            return allText;
        }

        public ActionResult PrintOpen(OpenRequest openRequest)
        {
            return Content(Workbook.Open(openRequest));
        }

        public void PrintSave(SaveSettings saveSettings)
        {
