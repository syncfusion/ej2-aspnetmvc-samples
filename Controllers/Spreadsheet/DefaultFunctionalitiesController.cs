           ...
           List<object> data = new List<object>()
            {
                ...
                new { CustomerName= "Hakeem Easseby",  Model= "Mirage",  Color= "Crimson",  PaymentMode= "Debit Card",  DeliveryDate= "9/12/2014",  Amount= "5619.25" },
                ...
                new { CustomerName= "Fax Witherspoon",  Model= "Range Rover Sport",  Color= "Orange",  PaymentMode= "Credit Card",  DeliveryDate= "2/22/2018",  Amount= "5284.87" }
            };
