...
namespace EJ2MVCSampleBrowser.Controllers.Spreadsheet
{
    public partial class SpreadsheetController : Controller
    {
        public ActionResult dataValidation()
        {
            ...
            {
                new { EmployeeId= "1001",  EmployeeName= "Vin Disel",  Date= "04-05-2021",  Weekday= "Mon",  TimeIn= "8:00 AM",  TimeOut= "10:00 PM",  HoursWorked= "14",  Basic= "=G4*30",  GrossPay= "=Sum(H4 + ((G4-8)*15))" },
                new { EmployeeId= "1002",  EmployeeName= "Steve",  Date= "04-06-2021",  Weekday= "Tue",  TimeIn= "8:00 AM",  TimeOut= "6:00 PM",  HoursWorked= "10",  Basic= "=G5*30",  GrossPay= "=Sum(H5 + ((G5-8)*15))" },
                new { EmployeeId= "1003",  EmployeeName= "Paul Waulker",  Date= "04-06-2021",  Weekday= "Tue",  TimeIn= "11:00 AM",  TimeOut= "4:00 PM",  HoursWorked= "9",  Basic= "=G6*30",  GrossPay= "=Sum(H6 + ((G6-8)*15))" },
                new { EmployeeId= "1004",  EmployeeName= "John",  Date= "04-08-2021",  Weekday= "Thu",  TimeIn= "8:00 AM",  TimeOut= "4:00 PM",  HoursWorked= "8",  Basic= "=G7*30",  GrossPay= "=Sum(H7 + ((G7-8)*15))" },
