...
namespace EJ2MVCSampleBrowser.Controllers.ListView
{
    public partial class ListViewController : Controller
    {
        ...
        public ActionResult Template()
        {
            ...
            newsData.Add(new NewsData(
                ...
                "Did you know our first e-book was published in May 2012? jQuery Succinctly was the start of over...",
                 "<p>Did you know our first e-book was published in May 2012? jQuery Succinctly was"
        ...
        + "which covers the insanity of the modern web.</p>"
            ...
            newsData.Add(new NewsData(
                ...
                "This guest blog post was written by Dave Lasike. He can be found on Twitter at @davelasike...",
                 "<p>This guest blog post was written by Dave Lasike. He can be found on Twitter at"
        ...
        + "events that are raised when generating the PDF.</p>"
            ...
            newsData.Add(new NewsData(
                ...
                "On October 17, Microsoft will release its Fall Creators Update for the Windows 10 platform...",
                 @"<p>On October 17, Microsoft will release its Fall Creators Update for the Windows 10 platform. Much like"
        ...
        + "http://main.acsevents.org/site/TR?pg=entry&fr_id=84845</p> "
            ...
            listdata.Add(new
            {
                ...
                imgSrc = Url.Content("~/Content/images/listview/1.png"),
            ...
            listdata.Add(new
            {
                ...
                text = "Syncfusion Blog",
                imgSrc = Url.Content("~/Content/images/listview/2.png"),
                timeStamp = "Syncfusion Blog - October 18, 2017",
                child = new List<object> {
                new {
                    id= "02_1", title=  newsData[1].title, category=  newsData[1].title, text=  newsData[1].title, imgSrc= "", heading= "", timeStamp= "", description=  newsData[1].content
                }
            }
            });
            listdata.Add(new
            {
                ...
                text = "Syncfusion Blog",
                imgSrc = Url.Content("~/Content/images/listview/3.png"),
                timeStamp = "Syncfusion Blog - October 18, 2017",
                child = new List<object> {
                new {
                    id= "03_1", title=  newsData[2].title, category=  newsData[2].title, text=  newsData[2].title, imgSrc= "", heading= "", timeStamp= "", description=  newsData[2].content
                }
            }
            });
            listdata.Add(new
            {
                ...
                text = "Syncfusion Blog",
                imgSrc = Url.Content("~/Content/images/listview/4.png"),
                timeStamp = "Syncfusion Blog - October 18, 2017",
                child = new List<object> {
                new {
                    id= "04_1", title=  newsData[3].title, category=  newsData[3].title, text=  newsData[3].title, imgSrc= "", heading= "", timeStamp= "", description=  newsData[3].content
                }
            }
            });
            listdata.Add(new
            {
                ...
                text = "Syncfusion Blog",
                imgSrc = Url.Content("~/Content/images/listview/5.png"),
                timeStamp = "Syncfusion Blog - October 17, 2017",
                child = new List<object> {
                new {
                    id= "05_1", title=  newsData[4].title, category=  newsData[4].title, text=  newsData[4].title, imgSrc= "", heading= "", timeStamp= "", description=  newsData[4].content
                }
            }
            });
            listdata.Add(new
            {
                ...
                text = "Syncfusion Blog",
                imgSrc = Url.Content("~/Content/images/listview/6.png"),
                timeStamp = "Syncfusion Blog - October 17, 2017",
                child = new List<object> {
                new {
                    id= "06_1", title=  newsData[5].title, category=  newsData[5].title, text=  newsData[5].title, imgSrc= "", heading= "", timeStamp= "", description=  newsData[5].content
                }
            }
            });
            listdata.Add(new
            {
                ...
                text = "Syncfusion Blog",
                imgSrc = Url.Content("~/Content/images/listview/7.png"),
                timeStamp = "Syncfusion Blog - October 13, 2017",
                child = new List<object> {
                new {
                    id= "07_1", title=  newsData[6].title, category=  newsData[6].title, text=  newsData[6].title, imgSrc= "", heading= "", timeStamp= "", description=  newsData[6].content
                }
            }
            });
    ...
    {
        public NewsData(string tit, string desc, string cont)
        {
            this.title = tit;
