...
namespace EJ2MVCSampleBrowser.Controllers.Toolbar
{
    public partial class ToolbarController : Controller
    {
        public ActionResult Template()
        {
            ...
            templateItems.Add(new ToolbarItem { Type = ItemType.Separator });
            templateItems.Add(new ToolbarItem { PrefixIcon = "e-icons e-zoom-out", TooltipText = "Zoom-Out", Text = "Bold", ShowTextOn = DisplayMode.Overflow, Align = ItemAlign.Left });
            ...
            templateItems.Add(new ToolbarItem { Type = ItemType.Separator });
            templateItems.Add(new ToolbarItem { PrefixIcon = "e-icons e-mouse-pointer", TooltipText = "Text Selection Tool", Text = "Text", ShowTextOn = DisplayMode.Overflow, Align = ItemAlign.Left });
            ...
            templateItems.Add(new ToolbarItem { Type = ItemType.Separator });
            templateItems.Add(new ToolbarItem { PrefixIcon = "e-pv-comment-icon", TooltipText = "Add Comments", Text = "Add", ShowTextOn = DisplayMode.Overflow, Align = ItemAlign.Left });
            templateItems.Add(new ToolbarItem { Type = ItemType.Separator });
            templateItems.Add(new ToolbarItem { Text = "Submit", Align = ItemAlign.Left });
