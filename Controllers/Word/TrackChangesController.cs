    ...
    public partial class WordController : Controller
    {
        ...
        public ActionResult TrackChanges(string Group1,string Button,string AuthorName)
        {
            ...
            if (Button == "View Template")
                return new TemplateResult("TrackChangesTemplate.docx", ResolveApplicationDataPath("Data\\Word"), HttpContext.ApplicationInstance.Response);

            // Opens a source document.
            WordDocument document = new WordDocument(ResolveApplicationDataPath("TrackChangesTemplate.docx", "Data\\Word"));
