...
namespace EJ2MVCSampleBrowser.Controllers.Word
{
    public partial class WordController : Controller
    {
        ...
        public ActionResult InsertBreak(string Group1)
        {
            ...
            paragraph = section.AddParagraph();
            //Inserting an Image.
            WPicture picture = paragraph.AppendPicture(new Bitmap(ResolveApplicationDataPath("Mountain-200.jpg", "Images\\Word"))) as WPicture;
            picture.Width = 120f;
            picture.Height = 90f;
            //Adding a new paragraph to the section.
            section.AddParagraph();
            ...
            section.AddParagraph();
            paragraph = section.AddParagraph();
            picture = paragraph.AppendPicture(new Bitmap(ResolveApplicationDataPath("Mountain-300.jpg", "Images\\Word"))) as WPicture;
            picture.Width = 120f;
            picture.Height = 90f;
            section.AddParagraph();
            paragraph = section.AddParagraph();
            ...
            section.AddParagraph();
            paragraph = section.AddParagraph();
            picture = paragraph.AppendPicture(new Bitmap(ResolveApplicationDataPath("Road-550-W.jpg", "Images\\Word"))) as WPicture;
            picture.Width = 120f;
            picture.Height = 90f;
            section.AddParagraph();
            paragraph = section.AddParagraph();
