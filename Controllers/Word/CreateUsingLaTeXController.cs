...
namespace EJ2MVCSampleBrowser.Controllers.Word
{
    ...
    {
        public ActionResult CreateUsingLaTeX(string Button, string Group1, string LaTeX)
        {
            if (Button == null)
                return View();
            ...
            if (Group1== "WordDocx")
            {
                return document.ExportAsActionResult("CreateEquationLaTeX.docx", FormatType.Docx, HttpContext.ApplicationInstance.Response, HttpContentDisposition.Attachment);
            }
            //Save as .pdf format
            else if (Group1 == "Pdf")
            {
                ...
                document.Close();
                converter.Dispose();
                return pdfDoc.ExportAsActionResult("CreateEquationLaTeX.pdf", HttpContext.ApplicationInstance.Response, HttpReadType.Save);
            }
