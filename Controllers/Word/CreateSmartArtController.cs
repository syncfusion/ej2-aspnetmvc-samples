...
namespace EJ2MVCSampleBrowser.Controllers.Word
{
    ...
    {
        public ActionResult CreateSmartArt(string Button, string SmartArtType)
        {
            if (Button == null)
                return View();
            ...
            // Open a document.
            document.Open(ResolveApplicationDataPath("CreateSmartArtInput.docx", "Data\\Word"), FormatType.Docx);
            string filename = "";
            switch (SmartArtType)
            {
                case "0":
            ...
            //Save as .docx format.
            return document.ExportAsActionResult(filename, FormatType.Docx, HttpContext.ApplicationInstance.Response, HttpContentDisposition.Attachment);
        }
        ...
        private void CreatePictureSmartArt(WordDocument document)
        {
            ...
            AddPicture(employeeNode1, ResolveApplicationDataPath("Nancy Davolio.png", "Images\\Word"));
            ...
            AddPicture(employeeNode2, ResolveApplicationDataPath("Andrew Fuller.png", "Images\\Word"));
            ...
            AddPicture(employeeNode3, ResolveApplicationDataPath("Janet Leverling.png", "Images\\Word"));
        }
