    ...
    public partial class WordController : Controller
    {
        ...
        public ActionResult LetterFormat(string Group1, string Button, string MapDataField)
        {
            ...
            if (Button == "View Template")
                return new TemplateResult("Letter Formatting.doc", ResolveApplicationDataPath("Data\\Word"), HttpContext.ApplicationInstance.Response);
            try
            {
                ...
                string dataPath = ResolveApplicationDataPath("Letter Formatting.doc", "Data\\Word");
