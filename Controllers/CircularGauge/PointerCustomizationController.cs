...
namespace EJ2MVCSampleBrowser.Controllers.CircularGauge
{
    public partial class CircularGaugeController : Controller
    {
        ...
        public ActionResult PointerCustomization()
        {
            ...
            pointer3.Border = new CircularGaugeBorder { Width = 1, Color = "#1E7145" };
            pointer3.Animation = new CircularGaugeAnimation { Enable = true, Duration = 1000 };
            ...
            pointer4.Cap = new CircularGaugeCap { Radius = 0, Color = "transparent" };
            pointer4.NeedleTail = new  CircularGaugeNeedleTail{ Length="4%", Color="#923C99" };
            pointer4.Animation = new CircularGaugeAnimation{ Enable = true, Duration = 900 };
