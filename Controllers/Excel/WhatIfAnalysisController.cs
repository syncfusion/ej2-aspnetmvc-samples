...
namespace EJ2MVCSampleBrowser.Controllers.Excel
{
    public partial class ExcelController : Controller
    {
        ...
        public ActionResult WhatIfAnalysis(string button, string chkbox)
        {
            if (button == null)
                return View();
            else if (button == "Input Template")
            {
                Stream ms = new FileStream(ResolveApplicationDataPath(@"WhatIfAnalysisTemplate.xlsx"), FileMode.Open, FileAccess.Read);
            ...
            else
            {
                ...
                using (ExcelEngine excelEngine = new ExcelEngine())
                {
                    ...
                    IWorkbook workbook = application.Workbooks.Open(ResolveApplicationDataPath(@"WhatIfAnalysisTemplate.xlsx"));
                    ...
                    return File(ms, "Application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "WhatIfAnalysis.xlsx");
                }
            }
        }
    }
