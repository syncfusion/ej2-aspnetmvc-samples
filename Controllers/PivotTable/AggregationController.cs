...
namespace EJ2MVCSampleBrowser.Controllers.PivotView
{
    public partial class PivotTableController : Controller
    {
        ...
        public List<AggregationFields> GetUnitData()
        {
            ...
            unitData.Add(new AggregationFields { value = "PercentageOfRunningTotals", text = "% of Running Totals" });
        ...
        public List<AggregationFields> GetCostData()
        {
            ...
            costData.Add(new AggregationFields { value = "PercentageOfRunningTotals", text = "% of Running Totals" });
